...
\newcommand{\tableTwoColumns}[3]{
\pgfplotstabletypeset[
     columns/A/.style={column name=\bfseries{#2}}
     , 1000 sep={}
     , columns/B/.style={column name=\bfseries{#3}}
     , every even row/.style={
       before row={\rowcolor[gray]{0.9}}}
     , every head row/.style={ before row=\toprule,after       row=\midrule}
     , every last row/.style={ after row=\bottomrule \hline}
     , col sep=semicolon
     , string type
     ]{#1}
}
...
\begin{frame}{Table readed from a file}
   \begin{table}
     \caption{Largest cities in the world (source: Wikipedia)}
     \centering
     \tableTwoColumns{data/data-table-example.csv}{City}{Population}
    \end{table} 
\end{frame}
...
\begin{frame}{Bar charts}
  \begin{figure}
    \begin{tikzpicture}
      ...
      \addplot+[draw opacity=0] plot coordinates {(1, 20) (2, 25) (3, 22.4) (4, 12.4)};
      \addplot+[draw opacity=0] plot coordinates {(1, 18) (2, 24) (3, 23.5) (4, 13.2)};
      \addplot+[draw opacity=0] plot coordinates {(1, 10) (2, 19) (3, 25) (4, 15.2)};
